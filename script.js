...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Data\": () => (/* binding */ Data)\n/* harmony export */ });\n/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./variables */ \"./source/js/variables.js\");\nconst reader = __webpack_require__(/*! g-sheets-api */ \"./node_modules/g-sheets-api/build/index.js\");\r\n\r\n\r\nasync function saveLang(shortName) {\r\n    await localStorage.setItem('lang', shortName);\r\n    console.log('lang was saved to cache')\r\n}\r\n\r\nasync function getLang() {\r\n    let res = await localStorage.getItem('lang');\r\n    await casheMassage(res, 'Lang')\r\n    return res\r\n}\r\nasync function saveListType(listType) {\r\n    await localStorage.setItem('listType', listType);\r\n    console.log('Type ' + listType + ' was saved to cache')\r\n}\r\nasync function getListType() {\r\n    let res = await localStorage.getItem('listType');\r\n    await casheMassage(res, 'List type')\r\n    return res;\r\n}\r\n\r\nasync function saveDataToLocalStorage(listType, add = '') {\r\n    await localStorage.setItem(listType + add, JSON.stringify(_variables__WEBPACK_IMPORTED_MODULE_0__.v[listType]));\r\n    console.log('data were saved to local storage into - ' + listType + add)\r\n}\r\n\r\nasync function getLocalStorageData(listType) {\r\n  let res = []\r\n  res =  await localStorage.getItem(listType);\r\n  if(res && res !== 'undefined') {\r\n    res = JSON.parse(res)\r\n    console.log('got cashe - ' + res.length + ' words of ' + listType + ' like ' + typeof res +', is array - ' + Array.isArray(res))\r\n    return res\r\n  } else {\r\n    console.log(res)\r\n    return false\r\n  }\r\n}\r\n// serj\r\n// async function getGoogleSheetData(listType) {\r\n//         let res = []\r\n//         await reader({\r\n//             apiKey: 'AIzaSyBGIB_zTm4GCRAIChXoqtSTEUpVujf_sxU',\r\n//             sheetId: '1aqssJJ9IvDDO21ylxiXSW2SjuPK5iO8r3tdZhGjGgBk',\r\n//             sheetNumber: 1,\r\n//             sheetName: v.listType,\r\n//             returnAllResults: false,\r\n//             }, (results) => {\r\n//             res = results\r\n//             console.log('got data from google spreadsheets - ' + results.length + ' words')\r\n//         })\r\n//         v[v.listType] = res\r\n//         console.log(v[v.listType])\r\n//         await saveDataToLocalStorage(listType);\r\n//         await saveDataToLocalStorage(listType, 'Cache');\r\n// }\r\n\r\n// Nikita\r\nasync function getGoogleSheetData(listType) {\r\n        let res = []\r\n        await reader({\r\n            apiKey: 'AIzaSyA-EQx9DYy5-nkIp2bEL8oqAyIsYjS_ocg',\r\n            sheetId: '1OemSkdo9IdPXxd0ZZcTr9-hBb3xZxbC4dqx9aDsAoVQ',\r\n            sheetNumber: 1,\r\n            sheetName: _variables__WEBPACK_IMPORTED_MODULE_0__.v.listType,\r\n            returnAllResults: false,\r\n            }, (results) => {\r\n            res = results\r\n            console.log('got data from google spreadsheets - ' + results.length + ' words')\r\n        })\r\n        _variables__WEBPACK_IMPORTED_MODULE_0__.v[_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType] = res\r\n        console.log(_variables__WEBPACK_IMPORTED_MODULE_0__.v[_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType])\r\n        await saveDataToLocalStorage(listType);\r\n        await saveDataToLocalStorage(listType, 'Cache');\r\n}\r\n\r\nconst Data = {\r\n    saveListType,\r\n    getListType,\r\n    saveLang,\r\n    getLang,\r\n    saveDataToLocalStorage,\r\n    getLocalStorageData,\r\n    getGoogleSheetData\r\n}\r\n\r\nconst casheMassage = (item, massage) => {\r\n console.log(item !== 'undefined' ? massage +' was got from cashe - ' + item : massage +' was not got from cashe') \r\n}\n\n//# sourceURL=webpack://word-learning/./source/js/data.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"f\": () => (/* binding */ f)\n/* harmony export */ });\n/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./variables */ \"./source/js/variables.js\");\n/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./data */ \"./source/js/data.js\");\n\r\n\r\n\r\nlet wordFlag = true\r\nlet wordId = 0\r\n\r\n// html object\r\nlet word = document.getElementById('word')\r\nlet translation = document.getElementById('translation')\r\nconst langsTitle = document.getElementById('langs-title')\r\nconst totalWords = document.getElementById('total-words')\r\n\r\n// functions\r\n\r\nconst getRundom = () => Math.floor(Math.random() * _variables__WEBPACK_IMPORTED_MODULE_0__.v[_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType].length)\r\n\r\nfunction changeLang() {\r\n  checkCache()\r\n  if (_variables__WEBPACK_IMPORTED_MODULE_0__.v.lang === 'eng') {\r\n    _variables__WEBPACK_IMPORTED_MODULE_0__.v.lang = 'ru'\r\n    _data__WEBPACK_IMPORTED_MODULE_1__.Data.saveLang('ru')\r\n    setLangsTitle()\r\n  } else {\r\n    _variables__WEBPACK_IMPORTED_MODULE_0__.v.lang = 'eng'\r\n    setLangsTitle()\r\n    _data__WEBPACK_IMPORTED_MODULE_1__.Data.saveLang('eng')\r\n  }\r\n}\r\nasync function changeList(type) {\r\n  _variables__WEBPACK_IMPORTED_MODULE_0__.v.listType = await type\r\n  await _data__WEBPACK_IMPORTED_MODULE_1__.Data.saveListType(type)\r\n  await checkCache()\r\n}\r\n \r\nfunction nextWord() {\r\n  if(_variables__WEBPACK_IMPORTED_MODULE_0__.v[_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType].length > 0) {\r\n    setTotalWords()\r\n    if(wordFlag === true) {\r\n      console.log('next word')\r\n      wordId = getRundom()\r\n      showWord()\r\n      wordFlag = !wordFlag;\r\n    } else {\r\n      showTranslation()\r\n      wordFlag = !wordFlag;\r\n    }\r\n  } else {\r\n    checkCache()\r\n  }\r\n        \r\n}\r\n\r\nfunction showWord() {\r\n    if (_variables__WEBPACK_IMPORTED_MODULE_0__.v.lang === 'eng') {\r\n      word.innerHTML = _variables__WEBPACK_IMPORTED_MODULE_0__.v[_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType][wordId].word\r\n    } else {\r\n      word.innerHTML = _variables__WEBPACK_IMPORTED_MODULE_0__.v[_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType][wordId].translation\r\n    }\r\n    _variables__WEBPACK_IMPORTED_MODULE_0__.v.speakVariable = _variables__WEBPACK_IMPORTED_MODULE_0__.v[_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType][wordId].word\r\n    translation.innerHTML = \"?\"\r\n  }\r\nfunction showTranslation() {\r\n    if (_variables__WEBPACK_IMPORTED_MODULE_0__.v.lang === 'eng') {\r\n      translation.innerHTML = _variables__WEBPACK_IMPORTED_MODULE_0__.v[_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType][wordId].translation\r\n    } else {\r\n      translation.innerHTML = _variables__WEBPACK_IMPORTED_MODULE_0__.v[_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType][wordId].word\r\n    }\r\n    _variables__WEBPACK_IMPORTED_MODULE_0__.v[_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType].splice(wordId, 1);\r\n    _data__WEBPACK_IMPORTED_MODULE_1__.Data.saveDataToLocalStorage(_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType);\r\n  }\r\n\r\nfunction setTotalWords() {\r\n  totalWords.innerHTML = _variables__WEBPACK_IMPORTED_MODULE_0__.v[_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType].length\r\n}\r\nasync function checkCache() {\r\n  let cache = await _data__WEBPACK_IMPORTED_MODULE_1__.Data.getLocalStorageData(_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType + 'Cache')\r\n  if ( cache && cache.length > 0 && cache !== 'undefined') {\r\n    wordFlag = await true\r\n    _variables__WEBPACK_IMPORTED_MODULE_0__.v[_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType] = cache\r\n    nextWord()\r\n  } else {\r\n    refreshData()\r\n  }\r\n}\r\nasync function refreshData() {\r\n    wordFlag = await true\r\n    await _data__WEBPACK_IMPORTED_MODULE_1__.Data.getGoogleSheetData(_variables__WEBPACK_IMPORTED_MODULE_0__.v.listType)\r\n    nextWord()\r\n}\r\nfunction setLangsTitle() {\r\n  langsTitle.innerHTML = _variables__WEBPACK_IMPORTED_MODULE_0__.v.langOrder[_variables__WEBPACK_IMPORTED_MODULE_0__.v.lang]\r\n}\r\n\r\n\r\n\r\nconst f = {\r\n  nextWord,\r\n  changeLang,\r\n  changeList,\r\n  setLangsTitle,\r\n  showWord,\r\n  showTranslation,\r\n  setTotalWords,\r\n  refreshData,\r\n  checkCache,\r\n}\r\n\r\n\r\n\n\n//# sourceURL=webpack://word-learning/./source/js/lib.js?");

/***/ }),

/***/ "./source/js/listener.js":
/*!*******************************!*\
  !*** ./source/js/listener.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _lib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib */ \"./source/js/lib.js\");\n/* harmony import */ var _speak__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./speak */ \"./source/js/speak.js\");\n/* harmony import */ var _swipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./swipe */ \"./source/js/swipe.js\");\n/* harmony import */ var _swipe__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_swipe__WEBPACK_IMPORTED_MODULE_2__);\n\r\n\r\n\r\n\r\n\r\nlet changeLangBtn = document.getElementById('change-lang-btn')\r\nlet speakEnglishBtn = document.getElementById('speak-btn')\r\nlet list1 = document.getElementById('list-1')\r\nlet list2 = document.getElementById('list-2')\r\n\r\n// change lang\r\nchangeLangBtn.addEventListener(\"click\", event => {\r\n    _lib__WEBPACK_IMPORTED_MODULE_0__.f.changeLang()\r\n})\r\n// shange list type\r\nlist1.addEventListener(\"click\", event => {\r\n    _lib__WEBPACK_IMPORTED_MODULE_0__.f.changeList('newList')\r\n})\r\nlist2.addEventListener(\"click\", event => {\r\n    _lib__WEBPACK_IMPORTED_MODULE_0__.f.changeList('oldList')\r\n})\r\n\r\n\r\n// mobile\r\ndocument.addEventListener('swiped-down', function(e) {\r\n    _lib__WEBPACK_IMPORTED_MODULE_0__.f.refreshData() // the element that was swiped\r\n});\r\ndocument.addEventListener('swiped-left', function(e) {\r\n   _lib__WEBPACK_IMPORTED_MODULE_0__.f.nextWord()\r\n});\r\n\r\n// desktop\r\ndocument.addEventListener(\"keypress\", function(event) {\r\n      // push space button \r\n      if (event.keyCode === 32) {\r\n        _lib__WEBPACK_IMPORTED_MODULE_0__.f.nextWord()\r\n      }\r\n      // push page up button \r\n      if (event.keyCode === 82) {\r\n        console.log('request from the user to update the data')\r\n        _lib__WEBPACK_IMPORTED_MODULE_0__.f.refreshData()\r\n      }\r\n    \r\n});\r\n\r\n// speak a word\r\nspeakEnglishBtn.addEventListener('click', () => {\r\n    speakEnglishBtn.setAttribute('disabled', '');\r\n    speakEnglishBtn.classList.toggle('btn-disabled')\r\n    ;(0,_speak__WEBPACK_IMPORTED_MODULE_1__.Speak)();\r\n    setTimeout(()=>{\r\n        speakEnglishBtn.removeAttribute('disabled');\r\n        speakEnglishBtn.classList.toggle('btn-disabled')\r\n    }, 2000)\r\n})\n\n//# sourceURL=webpack://word-learning/./source/js/listener.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_main_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../styles/main.scss */ \"./source/styles/main.scss\");\n/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./data */ \"./source/js/data.js\");\n/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./variables */ \"./source/js/variables.js\");\n/* harmony import */ var _lib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib */ \"./source/js/lib.js\");\n/* harmony import */ var _listener__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./listener */ \"./source/js/listener.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nasync function init() {\r\n  console.log('init start')  \r\n\r\n  let listType = '',\r\n      lang = '';\r\n  listType = await _data__WEBPACK_IMPORTED_MODULE_1__.Data.getListType()\r\n  lang = await _data__WEBPACK_IMPORTED_MODULE_1__.Data.getLang();\r\n\r\n  _variables__WEBPACK_IMPORTED_MODULE_2__.v.listType = await (listType !== 'undefined' && listType !== 'null') ? listType : 'newList';\r\n  _variables__WEBPACK_IMPORTED_MODULE_2__.v.lang = await lang !== 'undefined' ? lang : 'newList';\r\n  _lib__WEBPACK_IMPORTED_MODULE_3__.f.setLangsTitle()\r\n\r\n  console.log('init end')   \r\n}\r\n\r\nasync function beforeRender () {\r\n  // await Data.saveDataToLocalStorage(v.listType)\r\n  await _data__WEBPACK_IMPORTED_MODULE_1__.Data.saveLang(_variables__WEBPACK_IMPORTED_MODULE_2__.v.lang)\r\n  await _data__WEBPACK_IMPORTED_MODULE_1__.Data.saveListType(_variables__WEBPACK_IMPORTED_MODULE_2__.v.listType)\r\n}\r\n\r\nasync function start() {\r\n  console.log('preparing app for work')\r\n  await init()\r\n  let cashe = [];\r\n  console.log('before get cashe')  \r\n  cashe = await _data__WEBPACK_IMPORTED_MODULE_1__.Data.getLocalStorageData(_variables__WEBPACK_IMPORTED_MODULE_2__.v.listType);\r\n  console.log('after got cashe')\r\n  if (cashe !== 'undefined' && cashe.length > 0) {\r\n    console.log('first condition')\r\n    _variables__WEBPACK_IMPORTED_MODULE_2__.v[_variables__WEBPACK_IMPORTED_MODULE_2__.v.listType] =  cashe\r\n  } else {\r\n    console.log('second condition')\r\n    await _data__WEBPACK_IMPORTED_MODULE_1__.Data.getGoogleSheetData(_variables__WEBPACK_IMPORTED_MODULE_2__.v.listType)\r\n  }\r\n  await beforeRender();\r\n  console.log('app have begun work')\r\n  await _lib__WEBPACK_IMPORTED_MODULE_3__.f.nextWord()\r\n  \r\n}\r\n\r\nstart()\r\n\r\n\r\n\r\n\r\n\r\n  \n\n//# sourceURL=webpack://word-learning/./source/js/script.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Speak\": () => (/* binding */ Speak)\n/* harmony export */ });\n/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./variables */ \"./source/js/variables.js\");\n\r\nconst synth = window.speechSynthesis;\r\n\r\nfunction Speak() {\r\n  const utterThis = new SpeechSynthesisUtterance(_variables__WEBPACK_IMPORTED_MODULE_0__.v.speakVariable);\r\n  utterThis.lang = 'en-US'\r\n  utterThis.pitch = 1;\r\n  utterThis.rate = 1;\r\n  synth.speak(utterThis);\r\n}\r\n\r\n\n\n//# sourceURL=webpack://word-learning/./source/js/speak.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"v\": () => (/* binding */ v)\n/* harmony export */ });\nlet newList = [];\r\nlet oldList = [];\r\nlet newListCache = [];\r\nlet oldListCache = [];\r\nlet listType = 'newList';\r\n\r\nlet lang = 'eng';\r\nconst langOrder = {\r\n    eng: 'Deutsch - Russisch',\r\n    ru: 'Russisch - Deutsch'\r\n}\r\n\r\nlet speakVariable = ''\r\n\r\n\r\n\r\n\r\nconst v = {\r\n    newList,\r\n    oldList,\r\n    newListCache,\r\n    oldListCache,\r\n    lang,\r\n    langOrder,\r\n    listType,\r\n    speakVariable\r\n}\n\n//# sourceURL=webpack://word-learning/./source/js/variables.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("768ee2beaf0e4993cbf0")
/******/ 	})();
/******/ 	
